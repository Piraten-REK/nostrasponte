<?php get_header(); ?>
	<main class="py-6 pt-md-0">
		<section class="mt-3 mx-2 mt-md-6 mx-md-4 mx-lg-6 tag">
			<h1 class="page-title mt-0 mb-4 mb-md-8"><small><?php echo esc_html(__('Thema', 'nostrasponte')); ?></small><span><?php echo esc_html(get_queried_object()->name); ?></span></h1>
